...
public class Program {
    ...
    public void stergePlanificare(final String numeActivitate) {
        activitati.remove(numeActivitate);
        planificari.removeIf(new Predicate<Planificare>() {
            public boolean test(Planificare planificare) {
                return planificare.getActivitate().getNumeActivitate().equals(numeActivitate);
            }
        });
    }
